...
class CryptoInfo(symbol: String, price: Float, convert: String, percent_change_1h: Float, percent_change_24h: Float) {
    val symbol: String = symbol // Symbol ex. BTC
    val price: Float = price // Price ex. 44000
    val convert: String = "" // ex. USD (maybe fixed to the USD)
